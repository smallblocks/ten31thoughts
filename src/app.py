...
def start_scheduler():
    ...
    from .worker.scheduler import poll_all_feeds_job, process_analysis_job, weekly_synthesis_job
    ...
    scheduler.start()
    logger.info("Background scheduler started (poll=15min, analysis=5min, synthesis=Sunday 6AM)")
